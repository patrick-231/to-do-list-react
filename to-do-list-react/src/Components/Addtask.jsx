...
const Addtaskbtn = (task)=>{
  ...
  <div className="flex justify-between bg-yellow-100 shadow mb-2 w-full">
    <span className="w-full text-left leading-loose p-2 pl-10 cursor-pointer" onClick="checkTodo(this)">{task}</span>
  ...
  return (
    <div className="flex m-auto mt-10 justify-center p-2 bg-gray-300 w-3/5 ">
      <input type="text" className='rounded text-gray-700 p-4 justify-center align-center w-full ' placeholder="Write your to-do..." /> 
